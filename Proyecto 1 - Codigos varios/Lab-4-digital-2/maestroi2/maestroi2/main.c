...
uint8_t bufferI2C;		//Variable encargada de configurar comunicacion: Maestro - Esclavo
...
float voltaje_pot = 0;	//Variable para valores de Temperatura
float contador = 0;		//Variable para valores de Movimiento
float peso = 0;			// Variable para valores de peso 
